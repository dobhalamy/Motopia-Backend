const carouselSettingModel = require("../models/hero-carousel-setting");
const { BadRequest, NotAllowed, NotFound } = require("../helpers/api_error");

exports.heroCreateCarouselSetting = async (req, res, next) => {
...
exports.heroCarouselSettingList = async (req, res, next) => {
...
exports.heroUpdateCarouselSetting = async (req, res, next) => {
    try {
        const body = req.body;
        const carouselSetting = await carouselSettingModel.findOne();
